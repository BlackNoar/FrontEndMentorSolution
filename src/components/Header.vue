...
<template>
  <header
    class="h-[60px] dark:bg-dark-card dark:border-dark dark:text-white border shadow-md flex items-center"
  >
    <div class="container mx-auto flex justify-between items-center px-5 xl:px-0">
      ...
      <button @click="toggleTheme" class="md:text-lg text-sm flex items-center gap-1">
